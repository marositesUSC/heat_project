...
![RaspberryPi Imager Custom](images\RaspberryPi_setup_os_customization.png)
...
If connecting via [**PuTTY**](https://www.putty.org/) on your machine. Add your Raspberry Pi's IP address or Host Name.
